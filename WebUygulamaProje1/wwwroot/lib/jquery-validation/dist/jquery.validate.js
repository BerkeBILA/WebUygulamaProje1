...
$.extend( $.validator, {
	...
	messages: {
		...
		max: $.validator.format("Lütfen {0} veya daha az bir değer girin."),
		min: $.validator.format("Lütfen {0} veya daha fazla bir değer girin."),
		step: $.validator.format("Lütfen {0} katları bir sayı girin.")
	},
